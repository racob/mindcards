...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    // Declare the animation of cardNameLabel
    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)
        
        cardNameLabel.center.x -= view.bounds.width
    }
    ...
    func checkForMatches(_ secondFlippedCardIndex:IndexPath) {
        ...
        if cardOne.imageName == cardTwo.imageName {
            ...
            UIView.animate(withDuration: 0.2, delay: 2, options: [.curveEaseInOut ], animations: {
                ...
                self.cardNameLabel.center.x += self.view.bounds.width
                
            }, completion: nil)
            
            cardNameLabel.center.x = 140
